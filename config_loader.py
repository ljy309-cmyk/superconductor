...
_SCHEMA: dict[str, dict[str, tuple]] = {
    ...
    "tunneling": {
        ...
        "reflect_damping": (float, 0.0, 1.0),
        "bloch_lerp_speed": (float, 0.1, 100.0),
        "trial_history_max": (int, 100, 100000),
        "sim_left": (int, 0, 500),
        "sim_top": (int, 0, 500),
        "sim_width": (int, 100, 2000),
        "sim_height": (int, 100, 2000),
        "bloch_cx": (int, 0, 2000),
        "bloch_cy": (int, 0, 2000),
        "bloch_r": (int, 10, 500),
        "circle_steps": (int, 8, 256),
        "max_trails": (int, 1, 200),
        "trail_sample": (int, 1, 60),
        "trail_dot_radius": (int, 1, 20),
    },
    "qec_shield": {
