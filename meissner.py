...
def plot_meissner(sc_radius, n_grid, B_ext_direction, save_path=None):
    ...
    # 제목 및 축 설정
    ax.set_title("마이스너 효과 시뮬레이션\n(초전도체 내부: B = 0)", fontsize=14)
...
def run_meissner_simulation():
    ...
    try:
        ...
        print(f"\n설정: 반지름={sc_radius}, 격자={n_grid}x{n_grid}, 외부 자기장 세기={B_strength}")
        print("그래프를 생성합니다...\n")
